...
SET LOGS_INFO=html:C:\auto\sahi_pro\userdata\scripts\Sahi_Project_Lightning\offlineSahiLogs\
...
echo For WINDOWS mode startURL can be passed as " " and browserType can be passed as "none;windows"
...
echo %0 script_name.sah http://sahitest.com/demo/ "chrome;windows"
echo %0 script_name.sah " " "none;windows"
